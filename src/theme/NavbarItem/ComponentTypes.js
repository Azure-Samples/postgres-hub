...
const githubRepoButton = () => (
  <a
    href="https://github.com/Azure-Samples/postgres-hub"
    target="_blank"
  ...
  >
    <svg viewBox="0 0 24 24" width="24" height="24" className={style.githubIcon}>
      <path
        fill="currentColor"
...
export default {
  ...
  "custom-NavbarButtonGithub": githubRepoButton,
};
